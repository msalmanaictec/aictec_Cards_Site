...
namespace imageWriter.a22
{
    public partial class adha : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            System.Drawing.Image bitmap = (System.Drawing.Image)Bitmap.FromFile(Server.MapPath("//a22//aictec.png")); // set image 
            ...
            if (!IsPostBack)
            {
                ...
                {
                    Response.Redirect("~/a22/default.aspx");
                ...
                if (Request.QueryString["cmp"] != null)
                {
                    ...
                    switch (cmp)
                    {
                        ...
                        case 1:
                            bitmap = (System.Drawing.Image)Bitmap.FromFile(Server.MapPath("//a22//aictec.png"));
                            pName = new Point(540, 1697);
                            stringColor = System.Drawing.ColorTranslator.FromHtml("#ffffff");//customise color adding
                            fontsize = 50;
                            break;
                        case 2:
                            bitmap = (System.Drawing.Image)Bitmap.FromFile(Server.MapPath("//a22//leen.png"));
                            stringColor = System.Drawing.ColorTranslator.FromHtml("#00816f");//customise color adding
                            pName = new Point(540, 1470);
                            fontsize = 50;
                            break;
                        case 3:
                            bitmap = (System.Drawing.Image)Bitmap.FromFile(Server.MapPath("//a22//berry.png"));
                            stringColor = System.Drawing.ColorTranslator.FromHtml("#273262");//customise color adding
                            fontsize = 50;
                            break;
                        case 4:
                            bitmap = (System.Drawing.Image)Bitmap.FromFile(Server.MapPath("//a22//musahm.png"));
                            stringColor = System.Drawing.ColorTranslator.FromHtml("#3b3b3b");//customise color adding
                            fontsize = 15;                                                               //fontsize = 55;
                            pName = new Point(540, 1274);
                            break;
                        case 5:
                            bitmap = (System.Drawing.Image)Bitmap.FromFile(Server.MapPath("//a22//minasa.png"));
                            ...
                            break;
                        //case 6:
                        //    bitmap = (System.Drawing.Image)Bitmap.FromFile(Server.MapPath("//a22//sultan.png"));
                        //    stringColor = System.Drawing.ColorTranslator.FromHtml("#fd6c35");//customise color adding
                        //    pName = new Point(540, 1470);
                        //    fontsize = 55;
                        //    break;
                        case 7:
                            bitmap = (System.Drawing.Image)Bitmap.FromFile(Server.MapPath("//a22//MFC.png"));
                            fontsize = 55;
                            pName = new Point(540, 1565);
            ...
            graphicsImage.DrawString(   strName.Trim(),
                                        fontCairoBold,
